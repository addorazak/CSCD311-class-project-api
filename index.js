...
app.get("/hall_members", async (req, res) => {
  let students = await Students.find({ hall: req.query.hall });
  res.send(students);
});

mongoose.connect(
  "mongodb+srv://joe:mongojoe18@cluster0-7mtcg.mongodb.net/ug-hall?retryWrites=true&w=majority"
);
app.listen(1000, () => {
